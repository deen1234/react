      ...
      <div className="component-wrapper" style={{ margin: '1.5rem 0' }}>
        <Spin spinning={isLoading}>
          <FacilityConfirmationCard
            ...
            lat={facilityBookingData?.hotel?.latitude}
            lng={facilityBookingData?.hotel?.longitude}
          />
        </Spin>
      </div>
    </ComponentToPrint>
